...
Please visit the project's homepage at L<https://metacpan.org/release/SHARYANTO-Proc-Daemon-Prefork>.

=head1 SOURCE

Source repository is at L<https://github.com/sharyanto/perl-SHARYANTO-Proc-Daemon-Prefork>.

=head1 BUGS

Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=SHARYANTO-Proc-Daemon-Prefork>
